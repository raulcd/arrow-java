...
public final class TimeStampSecTZVector extends TimeStampVector
  ...
  /**
   * Instantiate a TimeStampSecTZVector. This doesn't allocate any memory for the data in vector.
   *
  ...
  *----------------------------------------------------------------*/
  ...
  /**
   * Same as {@link #set(int, NullableTimeStampSecTZHolder)} except that it handles the case when
  ...
  /**
   * Same as {@link #set(int, TimeStampSecTZHolder)} except that it handles the case when index is
  ...
  *----------------------------------------------------------------*/
  ...
  public TransferPair getTransferPair(String ref, BufferAllocator allocator) {
    TimeStampSecTZVector to = new TimeStampSecTZVector(ref, field.getFieldType(), allocator);
